...
set CSPB_JNI_DIR=e:\Games\PROJECT_LOBBY_CSPB\com.cspb.m\CSPB-ANDROID-OPEN-SOURCE
set ANDROID_PROJECT_DIR=e:\Games\PROJECT_LOBBY_CSPB\com.cspb.m\xash3d-fwgs\android

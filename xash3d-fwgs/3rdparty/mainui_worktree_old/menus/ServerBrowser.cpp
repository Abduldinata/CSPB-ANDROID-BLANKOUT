...
void CMenuServerBrowser::_Init( void )
{
	...
	// Some Android CSPB packs run with custom/native server integrations where
	// this check may return false even though creating a local game is expected.
	// Keep Create Game accessible on Android and let runtime report real errors.

...
#define MULTIPLAYER_BACKUP		8	// CSPB Optimization: Reduced from 64 to save ~150MB RAM
#define SINGLEPLAYER_BACKUP		4	// CSPB Optimization: Reduced from 16
#define CMD_BACKUP			16	// CSPB Optimization: allow a lot of command backups for very fast systems
#define CMD_MASK			(CMD_BACKUP - 1)
#define NUM_PACKET_ENTITIES		256	// 170 Mb for multiplayer with 32 players (Now radically lower due to MULTIPLAYER_BACKUP reduction)

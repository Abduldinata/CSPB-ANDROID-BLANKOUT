...
#define Q_vsnprintf(a,b,c,d) vsnprintf(a, (size_t)(((int64_t)(b) <= 0) ? 0 : (((int64_t)(b) > 65535) ? 65535 : (size_t)(b))), c, d)
#define Q_snprintf(a,b,c,...) snprintf(a, (size_t)(((int64_t)(b) <= 0) ? 0 : (((int64_t)(b) > 65535) ? 65535 : (size_t)(b))), c, ##__VA_ARGS__)

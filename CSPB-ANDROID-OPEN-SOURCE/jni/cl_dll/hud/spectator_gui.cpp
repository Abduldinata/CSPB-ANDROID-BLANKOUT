...
int CHudSpectatorGui::Draw( float flTime )
{
	...
	FillRGBABlend(startpos, 0, ScreenWidth - startpos, INT_YPOS(2), 0, 0, 0, 0);
	FillRGBABlend(0, ScreenHeight - INT_YPOS(2), ScreenWidth, INT_YPOS(2), 0, 0, 0, 0);

	// divider
	FillRGBABlend( INT_XPOS(12.5), INT_YPOS(2) * 0.25, 1, INT_YPOS(2) * 0.5, r, g, b, 0 );
	...
	{ // draw team here
		int iLen = DrawUtils::HudStringLen("RED TEAM:", m_fTextScale );

		DrawUtils::DrawHudString( INT_XPOS(12.5) - iLen - 50 , INT_YPOS(2) * 0.25, INT_XPOS(12.5) - 50, "BLUE TEAM:", r, g, b, m_fTextScale );

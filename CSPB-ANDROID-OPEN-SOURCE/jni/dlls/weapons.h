...
// pb stuff
#define ASSAULT_SPEED	225
#define SG_SPEED		225
#define SMG_SPEED		230
#define HANDGUN_SPEED	230
#define SNIPER_SPEED		225
#define HEAVY_SNIPER_SPEED	220
#define KNIFE_SPEED		240
...
static CGrenade *ShootExplode(entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, int iTeam, unsigned short usEvent);


static CGrenade *ShootLpg(entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, int iTeam, unsigned short usEvent);
...
static CGrenade* ShootGas(entvars_t* pevOwner, Vector vecStart, Vector vecVelocity, float time, unsigned short usEvent);

	static CGrenade *ShootSatchelCharge(entvars_t *pevOwner, Vector vecStart, Vector vecVelocity);

//pb stuff 
static CGrenade* ShootMolotov(entvars_t* pevOwner, Vector vecStart, Vector vecVelocity, float time, unsigned short usEvent);

static CGrenade* ShootMedkit(entvars_t* pevOwner, Vector vecStart, Vector vecVelocity, float time, unsigned short usEvent);
...
static CGrenade *ShootExplode(entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, int iTeam, unsigned short usEvent) { return NULL; }

static CGrenade *ShootLpg(entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, int iTeam, unsigned short usEvent) { return NULL; }
...
static CGrenade *ShootGas(entvars_t* pevOwner, Vector vecStart, Vector vecVelocity, float time, unsigned short usEvent) { return NULL; }

	static CGrenade *ShootSatchelCharge(entvars_t *pevOwner, Vector vecStart, Vector vecVelocity) { return NULL; }

static CGrenade *ShootMolotov(entvars_t* pevOwner, Vector vecStart, Vector vecVelocity, float time, unsigned short usEvent) { return NULL; }

static CGrenade *ShootMedkit(entvars_t* pevOwner, Vector vecStart, Vector vecVelocity, float time, unsigned short usEvent) { return NULL; }
...
//pb stuff 
void EXPORT BounceTouchExplode(CBaseEntity *pOther);
...
void EXPORT Med_BounceTouch(CBaseEntity* pOther);
void EXPORT Med_Detonate();
void EXPORT Med_TumbleThink();
void Med_Explode(TraceResult* pTrace, int bitsDamageType);
...
virtual void WeaponName() override {};
virtual void QuickDeploy() override {};
virtual void QuickReload() override {};
...
BOOL DefaultDeploy2(int body, const char *szViewModel, const char *szWeaponModel, int iAnim, const char *szAnimExt, int skiplocal = 0);


	int DefaultReload(int iClipSize, int iAnim, float fDelay, int body = 0);
	int DefaultReloadQuick(int iClipSize, int iAnim, float fDelay, int body = 0);

...
void Radio1(CBasePlayer *player, int slot)
{
	...
	player->m_flRadioTime = gpGlobals->time + 0.7f;

	switch (slot)
	{
	case 1:
		//player->Radio("%!MRAD_COVERME", "#Cover_me");
switch (player->m_iModelName)
		{
//tr
                           case MODEL_TERROR:
player->Radio("%!MRAD_COVERME", "#Cover_me");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_COVERMEF", "#Cover_me");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_COVERME", "#Cover_me");
			break;
...
player->Radio("%!MRAD_TAKEPOINT", "#You_take_the_point");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_TAKEPOINTF", "#You_take_the_point");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_TAKEPOINT", "#You_take_the_point");
			break;
...
player->Radio("%!MRAD_POSITION", "#Hold_this_position");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_POSITIONF", "#Hold_this_position");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_POSITION", "#Hold_this_position");
			break;
...
player->Radio("%!MRAD_REGROUP", "#Regroup_team");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_REGROUPF", "#Regroup_team");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_REGROUP", "#Regroup_team");
			break;
...
player->Radio("%!MRAD_FOLLOWME", "#Follow_me");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_FOLLOWMEF", "#Follow_me");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_FOLLOWME", "#Follow_me");
			break;
...
player->Radio("%!MRAD_HITASSIST", "#Taking_fire");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_HITASSISTF", "#Taking_fire");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_HITASSIST", "#Taking_fire");
			break;
...
player->Radio("%!MRAD_GO", "#Go_go_go");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_GOF", "#Go_go_go");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_GO", "#Go_go_go");
			break;
...
player->Radio("%!MRAD_FALLBACK", "#Team_fall_back");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_FALLBACKF", "#Team_fall_back");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_FALLBACK", "#Team_fall_back");
			break;
...
player->Radio("%!MRAD_STICKTOG", "#Stick_together_team");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_STICKTOGF", "#Stick_together_team");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_STICKTOG", "#Stick_together_team");
			break;
...
player->Radio("%!MRAD_GETINPOS", "#Get_in_position_and_wait");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_GETINPOSF", "#Get_in_position_and_wait");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_GETINPOS", "#Get_in_position_and_wait");
			break;
...
player->Radio("%!MRAD_STORMFRONT", "#Storm_the_front");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_STORMFRONTF", "#Storm_the_front");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_STORMFRONT", "#Storm_the_front");
			break;
...
player->Radio("%!MRAD_REPORTIN", "#Report_in_team");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_REPORTINF", "#Report_in_team");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_REPORTIN", "#Report_in_team");
			break;
...
player->Radio("%!MRAD_AFFIRM", "#Affirmative");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_AFFIRMF", "#Affirmative");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_AFFIRM", "#Affirmative");
			break;
...
player->Radio("%!MRAD_ROGER", "#Roger_that");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_ROGERF", "#Roger_that");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_ROGER", "#Roger_that");
			break;
...
player->Radio("%!MRAD_ENEMYSPOT", "#Enemy_spotted");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_ENEMYSPOTF", "#Enemy_spotted");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_ENEMYSPOT", "#Enemy_spotted");
			break;
...
player->Radio("%!MRAD_BACKUP", "#Need_backup");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_BACKUPF", "#Need_backup");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_BACKUP", "#Need_backup");
			break;
...
player->Radio("%!MRAD_CLEAR", "#Sector_clear");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_CLEARF", "#Sector_clear");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_CLEAR", "#Sector_clear");
			break;
...
player->Radio("%!MRAD_INPOS", "#In_position");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_INPOSF", "#In_position");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_INPOS", "#In_position");
			break;
...
player->Radio("%!MRAD_REPRTINGIN", "#Reporting_in");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_REPRTINGINF", "#Reporting_in");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_REPRTINGIN", "#Reporting_in");
			break;
...
player->Radio("%!MRAD_BLOW", "#Get_out_of_there");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_BLOWF", "#Get_out_of_there");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_BLOW", "#Get_out_of_there");
			break;
...
player->Radio("%!MRAD_NEGATIVE", "#Negative");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_NEGATIVEF", "#Negative");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_NEGATIVE", "#Negative");
			break;
...
player->Radio("%!MRAD_ENEMYDOWN", "#Enemy_down");
			break;
		case MODEL_LEET:
player->Radio("%!MRAD_ENEMYDOWNF", "#Enemy_down");
			break;
		case MODEL_ARCTIC:
player->Radio("%!MRAD_ENEMYDOWN", "#Enemy_down");
			break;
...
constexpr const char *iEx[] = {
"weapon_hegrenade\n",//0
"null",//1
"weapon_gasbomb\n",//2
};

constexpr const char *iSpe[] = {
"weapon_smokegrenade\n",//0
"weapon_medkit\n",//1
"null",
}; */
...
else if (FStrEq(pcmd, "billflxcrypted_quickrespawn"))
{
player->m_fDeadTime = 0;
}

else if (FStrEq(pcmd, "billflxcrypted_mask0"))
{
player->pev->body = 0;
}

else if (FStrEq(pcmd, "billflxcrypted_mask1"))
{
player->pev->body = 1;
}

else if (FStrEq(pcmd, "billflxcrypted_mask2"))
{
player->pev->body = 2;
}

else if (FStrEq(pcmd, "billflxcrypted_mask3"))
{
player->pev->body = 3;
}

else if (FStrEq(pcmd, "billflxcrypted_mask4"))
{
player->pev->body = 4;
}

else if (FStrEq(pcmd, "billflxcrypted_mask5"))
{
player->pev->body = 5;
}
else if (FStrEq(pcmd, "billflxcrypted_mask6"))
{
player->pev->body = 6;
}
else if (FStrEq(pcmd, "billflxcrypted_mask7"))
{
player->pev->body = 7;
}
else if (FStrEq(pcmd, "billflxcrypted_mask8"))
{
player->pev->body = 8;
}
else if (FStrEq(pcmd, "billflxcrypted_mask9"))
{
player->pev->body = 9;
}
else if (FStrEq(pcmd, "billflxcrypted_mask10"))
{
player->pev->body = 10;
}
else if (FStrEq(pcmd, "billflxcrypted_mask11"))
{
player->pev->body = 11;
}
else if (FStrEq(pcmd, "billflxcrypted_mask12"))
{
player->pev->body = 12;
}
else if (FStrEq(pcmd, "billflxcrypted_mask13"))
{
player->pev->body = 13;
}
...
else if (FStrEq(pcmd, "billflxcrypted_megahp"))
{
player->pev->health = 130;
}
else if (FStrEq(pcmd, "billflxcrypted_quickdraw"))
{
...
else if (FStrEq(pcmd, "billflxcrypted_quickreload"))
{
if (player->pev->deadflag != DEAD_NO && !player->IsBot())
		return;
if (player->m_pActiveItem == NULL)
...
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"       COLT PYTHON\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_deagle_dual"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"       DUAL DEAGLE\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_dual_handgun"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"       DUAL HANDGUN\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_taurus_raging_bull"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     Tarurus Raging Bull\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_deagle"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     Desert Eagle        \"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_usp"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"         K5\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_glock18"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     Glock 18\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_bow"))
CLIENT_COMMAND(ENT(player->pev), "weaponName \"  Compound Bow        \"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_ak47"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"       AK47\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m1887"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"       M1887\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_aksopmod"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"       AK SOPMOD\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_aug"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"       AUG A3\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_awp"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 3 ;weaponName \"       L115A1\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_aug_hbar"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"       AUG HBAR\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_augblitz"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     AUG BLITZ\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_cheytac_m200"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 3 ;weaponName \"     Cheytac M200        \"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_dragunov"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 3 ;weaponName \"     Dragunov\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_p90"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     P90 Ext\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_aug_a3_silencer"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     AUG A3 SILENCER        \"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m82a1"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 3 ;weaponName \"     BARRETT M82A1\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_f2000"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     F2000\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_famas_g2"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     Famas G2 Commando\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_g36c"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     G36C\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_groza"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     GROZA\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_k1"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     K1\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_k2"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     K2\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_kar98k"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 3 ;weaponName \"     Kar98k\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_kriss_sv"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     Kriss SV\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_kriss_sv_silence"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     Kriss SV Silencer\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m4_cqb_lv1"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     M4 CQB LV1\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m4_cqb_lv2"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     M4 CQB LV2\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m4_spr_lv1"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     M4 SPR LV1\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m4_spr_lv2"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     M4 SPR LV2\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m4a1"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     M4A1\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m4a1_s"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     M4A1-S\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_mp7"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     MP7 Ext\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_oa93"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     OA93\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_p90_mc"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     P90-MC\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_pindad_ss2_v5"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     PINDAD SS2 V5\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_rangemaster_338"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 3 ;weaponName \"     RANGEMASTER 338\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_sc2010"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     SC 2010\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_scar_carbine"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     SCAR CARBINE\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_spas_15"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     SPAS 15\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_tactilite_t2"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 3 ;weaponName \"     TACTILITE T2        \"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_kriss_sv_batik"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     KRISS SV BATIK        \"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_kriss_sv_crb"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     KRISS SV CRB\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m4a1_s"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     M4A1 S\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_zombie_s"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     ZOMBIE SLAYER\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_mp5k"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     MP5K\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m4_azure"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     HK 417\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_mp9"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     MP9\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m3"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     870MCS\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_scout"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 3 ;weaponName \"     SSG 69\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_sg550"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     SG 550\"\n");
//new
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_aksopmod_cg"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     AK SOPMOD CG\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_aug_esport"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     AUG E-SPORT\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_t77"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     T77\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_apc"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 0 ;weaponName \"     APC9\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_fg42"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     FG42\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_msbs"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     MSBS\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_as50"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 3 ;weaponName \"     AS50\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_m1887_w"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     M1887 W\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_pgm"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 3 ;weaponName \"     PGM\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_ump"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     UMP 45\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_sig"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     SIG SAUER\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_spectre"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     SPECTRE\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_tar"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     TAR-21\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_xm8"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     XM8\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_water"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     WATER GUN\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_knife"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     M-7\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_amok"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     AMOK KUKRI\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_saber"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     SABER \"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_arabian_sword"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     ARABIAN SWORD\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_fangblade"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     FANGBLADE\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_combat"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     COMBAT MACHETE        \"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_knifebone"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     BONE KNIFE\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_brass_knuckle"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     BRASS KNUCKLES\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_candy_cane"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     CANDY CANE\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_dual_knife"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     DUAL KNIFE\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_keris"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     KERIS\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_mini_axe"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     MINI AXE\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_knife"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     M-7\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_ice"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     KNIGHT SWORD        \"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_karambit"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     KARAMBIT\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_butterfly"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     BUTTERFLY\"\n");


//grenade
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_medkit"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     MEDICAL KIT\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_hegrenade"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     K400\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_smokegrenade"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     SMOKE\"\n");
else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_gasbomb"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     WATERMELON PALESTINE\"\n");

else if (FClassnameIs(player->m_pActiveItem->pev,"weapon_c4"))
CLIENT_COMMAND(ENT(player->pev), "pb_crosshair 1 ;weaponName \"     C-4 EXPLOSIVE\"\n");
...
CLIENT_COMMAND(ENT(player->pev), "showQ\n");
			...
			else if (FStrEq(pcmd, "pbbuy"))
			{
				MoE_HandleBuyCommands(player, CMD_ARGV_(1));
			}
			else if (FStrEq(pcmd, "throwable"))
			{
				MoE_Throwable(player, CMD_ARGV_(1));
			}
			else
			{
...
void EXT_FUNC ServerActivate(edict_t *pEdictList, int edictCount, int clientMax)
{
	...
	for (i = 0; i < edictCount; ++i)
	{
		...
		// Some broken map entities arrive with obviously invalid private-data
...
PRECACHE_SOUND("player/female/die1.wav");
PRECACHE_SOUND("vox/hit_human.wav");
PRECACHE_SOUND("vox/hithuman.wav");
PRECACHE_SOUND("nautilus/misc/hit_human_1.wav");
PRECACHE_SOUND("nautilus/misc/headshot1.wav");
PRECACHE_SOUND("nautilus/misc/headshot2.wav");
PRECACHE_SOUND("nautilus/misc/headshot3.wav");
PRECACHE_SOUND("nautilus/misc/headshot4.wav");
PRECACHE_SOUND("nautilus/misc/headshot1.wav");
PRECACHE_SOUND("nautilus/medkit_effect.wav");



PRECACHE_SOUND("effect/MV_Ann_Bomb_Disarm.wav");

PRECACHE_SOUND("debris/WM_Shotgun_Hit_Wood_1.wav");
PRECACHE_SOUND("debris/WM_Shotgun_Hit_Ground_1.wav");
PRECACHE_SOUND("debris/WM_Shotgun_Hit_Metal_1.wav");
PRECACHE_SOUND("debris/WM_Hit_GrazeBullet_1.wav");
PRECACHE_SOUND("debris/WM_Hit_GrazeBullet_2.wav");
PRECACHE_SOUND("debris/WM_Hit_GrazeBullet_3.wav");
...
PRECACHE_SOUND("vox/breath.wav");
PRECACHE_SOUND("vox/breathe1.wav");
PRECACHE_SOUND("vox/breathe2.wav");
PRECACHE_SOUND("vox/chainheadshot.wav");
PRECACHE_SOUND("vox/chainkiller.wav");
PRECACHE_SOUND("vox/chainstopper.wav");
PRECACHE_SOUND("vox/doublekill.wav");
PRECACHE_SOUND("vox/firstkill.wav");
PRECACHE_SOUND("vox/headshot.wav");
PRECACHE_SOUND("vox/triplekill.wav");

PRECACHE_SOUND(weapon_sound_ak47.string);
PRECACHE_SOUND(weapon_sound_aksopmod.string);
PRECACHE_SOUND(weapon_sound_aug_hbar.string);
PRECACHE_SOUND(weapon_sound_aug.string);
PRECACHE_SOUND(weapon_sound_augblitz.string);
PRECACHE_SOUND(weapon_sound_p90.string);
PRECACHE_SOUND(weapon_sound_aug_a3_silencer.string);
PRECACHE_SOUND(weapon_sound_f2000.string);
PRECACHE_SOUND(weapon_sound_famas_g2.string);
PRECACHE_SOUND(weapon_sound_g36c.string);
PRECACHE_SOUND(weapon_sound_k1.string);
PRECACHE_SOUND(weapon_sound_k2.string);
PRECACHE_SOUND(weapon_sound_kriss_sv.string);
PRECACHE_SOUND(weapon_sound_kriss_sv_dual.string);
PRECACHE_SOUND(weapon_sound_kriss_sv_silencer.string);
PRECACHE_SOUND(weapon_sound_kriss_sv_silencer_dual.string);
PRECACHE_SOUND(weapon_sound_m4_cqb_lv1.string);
PRECACHE_SOUND(weapon_sound_m4_cqb_lv2.string);
PRECACHE_SOUND(weapon_sound_m4a1.string);
PRECACHE_SOUND(weapon_sound_m4a1_s.string);
PRECACHE_SOUND(weapon_sound_mp7.string);
PRECACHE_SOUND(weapon_sound_oa93.string);
PRECACHE_SOUND(weapon_sound_oa93_dual.string);
PRECACHE_SOUND(weapon_sound_p90_mc.string);
PRECACHE_SOUND(weapon_sound_pindad_ss2_v5.string);
PRECACHE_SOUND(weapon_sound_groza.string);
PRECACHE_SOUND(weapon_sound_sc2010.string);
PRECACHE_SOUND(weapon_sound_scar_carbine.string);
PRECACHE_SOUND(weapon_sound_kriss_sv_crb.string);
PRECACHE_SOUND(weapon_sound_kriss_sv_crb_dual.string);
PRECACHE_SOUND(weapon_sound_mp5k.string);
PRECACHE_SOUND(weapon_sound_m4_azure.string);
PRECACHE_SOUND(weapon_sound_mp9.string);
PRECACHE_SOUND(weapon_sound_sg550.string);
PRECACHE_SOUND(weapon_sound_l115a1.string);
PRECACHE_SOUND(weapon_sound_cheytac_m200.string);
PRECACHE_SOUND(weapon_sound_dragunov.string);
PRECACHE_SOUND(weapon_sound_kar98k.string);
PRECACHE_SOUND(weapon_sound_rangemaster_338.string);
PRECACHE_SOUND(weapon_sound_m82a1.string);
PRECACHE_SOUND(weapon_sound_tactilite_t2.string);
PRECACHE_SOUND(weapon_sound_ssg69.string);
PRECACHE_SOUND(weapon_sound_m4_spr_lv1.string);
PRECACHE_SOUND(weapon_sound_m4_spr_lv2.string);
PRECACHE_SOUND(weapon_sound_m1887.string);
PRECACHE_SOUND(weapon_sound_spas_15.string);
PRECACHE_SOUND(weapon_sound_zombie_s.string);
PRECACHE_SOUND(weapon_sound_870mcs.string);
PRECACHE_SOUND(weapon_sound_ak_sopmod_cg.string);
PRECACHE_SOUND(weapon_sound_aug_esport.string);
PRECACHE_SOUND(weapon_sound_t77.string);
PRECACHE_SOUND(weapon_sound_apc.string);
PRECACHE_SOUND(weapon_sound_fg42.string);
PRECACHE_SOUND(weapon_sound_msbs.string);
PRECACHE_SOUND(weapon_sound_as50.string);
PRECACHE_SOUND(weapon_sound_m1887_w.string);
PRECACHE_SOUND(weapon_sound_pgm.string);
PRECACHE_SOUND(weapon_sound_ump.string);
PRECACHE_SOUND(weapon_sound_sig.string);
PRECACHE_SOUND(weapon_sound_spectre.string);
PRECACHE_SOUND(weapon_sound_tar.string);
PRECACHE_SOUND(weapon_sound_xm8.string);
PRECACHE_SOUND(weapon_sound_water_gun.string);
PRECACHE_SOUND(weapon_sound_colt_python.string);
PRECACHE_SOUND(weapon_sound_deagle_dual.string);
PRECACHE_SOUND(weapon_sound_dual_handgun.string);
PRECACHE_SOUND(weapon_sound_raging_bull.string);
PRECACHE_SOUND(weapon_sound_deagle.string);
...
PRECACHE_SOUND(weapon_sound_glock.string);
	...
	PRECACHE_MODEL("models/p_k400.mdl");

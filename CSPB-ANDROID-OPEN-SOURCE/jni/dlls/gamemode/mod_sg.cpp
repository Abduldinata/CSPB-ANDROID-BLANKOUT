...
void CMod_TeamDeathMatchSG::InstallPlayerModStrategy(CBasePlayer *player)
{
...
CMod_TeamDeathMatchSG::CMod_TeamDeathMatchSG()
{
...
void CMod_TeamDeathMatchSG::Think(void)
{
...
void CMod_TeamDeathMatchSG::PlayerKilled(CBasePlayer *pVictim, entvars_t *pKiller, entvars_t *pInflictor)
{
...
BOOL CMod_TeamDeathMatchSG::FPlayerCanTakeDamage(CBasePlayer *pPlayer, CBaseEntity *pAttacker)
{
...
int CountTeamPlayersSg(int iTeam)
{
...
BOOL CMod_TeamDeathMatchSG::FPlayerCanRespawn(CBasePlayer *pPlayer)
{
	CHalfLifeMultiplay *mp = g_pGameRules;

	mp->m_iNumCT = CountTeamPlayersSg(CT);
	mp->m_iNumTerrorist = CountTeamPlayersSg(TERRORIST);
...
void CMod_TeamDeathMatchSG::UpdateGameMode(CBasePlayer *pPlayer)
{
...
void CMod_TeamDeathMatchSG::PlayerSpawn(CBasePlayer *pPlayer)
{

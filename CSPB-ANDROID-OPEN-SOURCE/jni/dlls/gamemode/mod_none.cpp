...
void CMod_None::PlayerSpawn(CBasePlayer *pPlayer)
{
...
void CMod_SniperB::CheckMapConditions()
{
	IBaseMod::CheckMapConditions();
	//m_mapBombZones.clear();
...
void CMod_SniperB::InstallPlayerModStrategy(CBasePlayer *player)
{
	class MyPlayerModStrategy : public CPlayerModStrategy_Default
	{
	public:
...
void CMod_SniperB::UpdateGameMode(CBasePlayer *pPlayer)
{
...
void CMod_SniperB::PlayerSpawn(CBasePlayer *pPlayer)
{
...
//knifeb 
void CMod_knifeB::CheckMapConditions()
{
	IBaseMod::CheckMapConditions();
	//m_mapBombZones.clear();
	if (m_bMapHasBombZone)
...
void CMod_knifeB::InstallPlayerModStrategy(CBasePlayer *player)
{
	class MyPlayerModStrategy : public CPlayerModStrategy_Default
	{
	public:
...
void CMod_knifeB::UpdateGameMode(CBasePlayer *pPlayer)
{
...
void CMod_knifeB::PlayerSpawn(CBasePlayer *pPlayer)
{

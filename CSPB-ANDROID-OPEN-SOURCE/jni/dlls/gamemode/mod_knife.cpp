...
void CMod_TeamDeathMatchKnife::InstallPlayerModStrategy(CBasePlayer *player)
{
...
CMod_TeamDeathMatchKnife::CMod_TeamDeathMatchKnife()
{
...
void CMod_TeamDeathMatchKnife::Think(void)
{
...
void CMod_TeamDeathMatchKnife::PlayerKilled(CBasePlayer *pVictim, entvars_t *pKiller, entvars_t *pInflictor)
{
...
BOOL CMod_TeamDeathMatchKnife::FPlayerCanTakeDamage(CBasePlayer *pPlayer, CBaseEntity *pAttacker)
{
...
int CountTeamPlayersKnife(int iTeam)
{
...
void CMod_TeamDeathMatchKnife::PlayerSpawn(CBasePlayer *pPlayer)
{

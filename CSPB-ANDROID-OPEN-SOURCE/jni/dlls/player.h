...
class headshot_ann : public CBaseMonster
{
public:
...
void Trace(Vector vecSrc, Vector vecDir, float flDamage, float flRadius, int bitsDamageType, entvars_t* pevInflictor, entvars_t* pevAttacker);
...
bool m_bSluggerKilled;
float VictimKilled;
float round_frags;
float round_frags_headshot;
float round_frags_grenade;
float round_frags_knife;
float round_frags_shotgun;
float round_frags_sniper;
	bool m_bFirstShotAfterRespawn;
	int m_iLastAssistAttacker;
	float m_flLastAssistTime;
	int m_iKillLead;

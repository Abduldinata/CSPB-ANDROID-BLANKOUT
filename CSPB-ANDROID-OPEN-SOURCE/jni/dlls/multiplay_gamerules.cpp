...
SERVER_COMMAND("Mission_Announcement_Blue\n");
SERVER_EXECUTE();
...
SERVER_COMMAND("Mission_Announcement_Red\n");
SERVER_EXECUTE();
...
SERVER_COMMAND("clearlistkill 0\n");
...
MESSAGE_BEGIN(MSG_ONE, gmsgInventoryGive, NULL, pPlayer->pev);
MESSAGE_END();
...
void CHalfLifeMultiplay::PlayerKilled(CBasePlayer *pVictim, entvars_t *pKiller, entvars_t *pInflictor)
{
	...
	if (pVictim->pev == pKiller) //bill = disable for cspb
	{
